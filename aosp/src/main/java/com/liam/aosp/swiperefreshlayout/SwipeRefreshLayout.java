...
package com.liam.aosp.swiperefreshlayout;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
   ...
   * its resting position. Use {@link #DEFAULT_SLINGSHOT_DISTANCE} to reset to the default value.
   */
  ...
  private void setRefreshing(boolean refreshing, final boolean notify) {
    if (mRefreshing != refreshing) {
      ...
      if (mRefreshing) {
        ...
        RotateAnimation rotate = new RotateAnimation(0, 360, mCircleView.getPivotX(), mCircleView.getPivotY());
